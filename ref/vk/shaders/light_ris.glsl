...
#if LIGHT_POLYGON
	computePolygonLightingRIS(P, geometry_N, shading_N, V, material, cluster_index, pix, ris_active, diffuse, specular);
#endif

#if LIGHT_POINT
	computePointLightingRIS(P, geometry_N, shading_N, V, material, cluster_index, pix, ris_active, diffuse, specular, flashlight_diffuse, flashlight_specular);
#endif
}
