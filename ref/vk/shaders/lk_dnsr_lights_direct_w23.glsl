...
#ifndef SECOND_POSITION
#define SECOND_POSITION refl_position_t
#endif
...
#else
	const vec3 second_pos = imageLoad(SECOND_POSITION, pix).xyz;
	const vec3 direction = normalize(pos - second_pos);
#endif
